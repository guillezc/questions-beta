	...
	Datepicker.prototype = {
      ...
      var element = this.component ? this.element.find('input') : this.element;
		...
		getClassNames: function(date){
			...
			for(var ii=0;ii<this.dates.length;ii++){
				if (
					date.getUTCFullYear() === this.dates[ii].getFullYear() &&
					date.getUTCMonth() === this.dates[ii].getMonth() &&
					date.getUTCDate() === this.dates[ii].getDate()){
					cls.push('active');
				}
			}
