    ...
    var a = "layouts/layout/img/",
        ...
        r = function(e, a) {
            ...
            if ("click" === e || "set" === e ? a = $(a) : "match" === e && s.find("li > a").each(function() {
					...
					if(typeof e !== typeof undefined){
						return e.length > 1 && t.substr(1, e.length - 1) == e.substr(1, e.length -6) ? void(a = $(this)) : void 0;
					}else{
                        e = $(this).attr("data-href");
                        _t = t;
                        t = _t == "" ? "/sesiones" : _t;
						return e.length > 1 && t.substr(1) == e ? void(a = $(this)) : void 0;
                    }
                }), a && 0 != a.size() && "javascript:;" !== a.attr("href") && "#" !== a.attr("href")) {
        ...
        l = function() {
            $(".page-sidebar-mobile-offcanvas .responsive-toggler").click(function() {
                ...
                if($(this).parents(".page-sidebar-menu").hasClass("sidebar-questions")){
                    if(App.getViewPort().width > i) { r("click", $(this)); }
                }
